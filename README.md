...
###REMÉDIOS QUE GERALMENTE NÃO DÃO REAÇÕES
	...
	- Para dor muscular: Parenzyme Analgésico, Dorilax.
	- Para Enxaqueca: Derivados do Ergot (Cefalium, Ormigrein, Parcel, Sandomigran, Tylenol DC 1 comp. por vez.
	- Para cólicas: Buscopam Simples, Busco-DUO.
	- Para gripes: Descon, Dimettap, Claritin D, Naldecon, Trimedal, Coldrim, Resprin, Allegra D. Zyrtec D.
	- Para dores moderada: Dividol.
	- Os anti-inflamatórios esteroidais (Corticosteróides) podem ser utilizados a critério do médico.
